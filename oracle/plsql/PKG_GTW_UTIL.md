...
CREATE OR REPLACE PACKAGE BODY PKG_GTW_UTIL IS
  ...
  procedure prc_gravar_log(p_ds_data in gtw_logs.gtw_log.ds_data%type,
                           p_cd_identificador_cvc in gtw_logs.gtw_log.cd_identificador_cvc%type,
  ...
  is
    ...
    v_cd_identificador_cvc   gtw_logs.gtw_log.cd_identificador_cvc%type := p_cd_identificador_cvc;
